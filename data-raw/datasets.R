...
library(rmarkdown)
render('accessingData.Rmd', envir=topenv(), output_dir='../inst/extdata/Logfiles', clean=FALSE)
...
objectsToKeep <- c('hai','exprs') # if it's a collection of unsystematically-named objects
